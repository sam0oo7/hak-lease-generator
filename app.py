...
with st.form("lease_form"):
    ...
    with st.expander("👥 Tenant Details"):
        ...
        tenant_company        = st.text_input("Tenant Company", "Tenant Company Name comes here")
        tenant_address        = st.text_input("Tenant Address", "Tenant Address comes here")
        tenant_company_number = st.text_input("Tenant Company No.", "Tenant Company No. comes here")
        tenant_signatory      = st.text_input("Tenant Signatory", "Tenant Signatory comes here")
        tenant_phone          = st.text_input("Tenant Phone", "Tenant No. comes here")
    ...
    with st.expander("💷 Financials & Use"):
        ...
        base_rent_note        = st.text_input("Landlord’s Note (on Base Rent)", "Additional notes")
        permitted_use_address = st.text_input("Permitted Use Address", "Unit 2, 81 High St, NW10 4NT")
        permitted_use         = st.text_input("Permitted Use", "Services")
